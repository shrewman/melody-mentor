  ...
  return (
    <>
      ...
      <div className="container mx-auto p-5">
        <div className="mb-10 rounded-xl bg-surface0 p-5 text-center">
        ...
        <div className="grid grid-cols-1 gap-8 rounded-xl bg-surface0 p-5 md:grid-cols-5">
          <Link
            to="/recorder"
          ...
          >
            ...
            <p className="text-xl">
              Record your guitar sessions to listen back and analyze your
              playing.
            </p>
          </Link>
          <Link
